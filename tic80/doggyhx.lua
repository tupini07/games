...
local String = _hx_e()
local Std = _hx_e()
local WorldMap = _hx_e()
__entities_Doggy = _hx_e()
__lua_Boot = _hx_e()
__managers_SceneManager = _hx_e()
__physics_BaseCollider = _hx_e()
__physics_BoxCollider = _hx_e()
__physics_Vector2d = _hx_e()
__scenes_IScene = _hx_e()
__scenes_GameScene = _hx_e()
__scenes_IntroScene = _hx_e()
__utils_Camera = _hx_e()
...
Entity.new = function(x,y,dx,dy,accx,accy,collider) 
  local self = _hx_new(Entity.prototype)
  Entity.super(self,x,y,dx,dy,accx,accy,collider)
  return self
end
Entity.super = function(self,x,y,dx,dy,accx,accy,collider) 
  self.pos = __physics_Vector2d.new(x, y);
  self.delta_v = __physics_Vector2d.new(dx, dy);
  self.acceleration = __physics_Vector2d.new(accx, accy);
  self.collider = collider;
  Entity.all_entities:push(self);
end
Entity.reset = function() 
  Entity.all_entities = _hx_tab_array({}, 0);
end
Entity.update_all_entities = function() 
  local _g = 0;
  local _g1 = Entity.all_entities;
...
Entity.draw_all_entities = function() 
  local _g = 0;
  local _g1 = Entity.all_entities;
  while (_g < _g1.length) do 
    local e = _g1[_g];
...
Entity.prototype = _hx_a();
Entity.prototype.update_physics = function(self) 
  local tmp = self.pos;
  tmp.x = tmp.x + self.delta_v.x;
  local tmp1 = self.pos;
  tmp1.y = tmp1.y + self.delta_v.y;
  local tmp2 = self.delta_v;
  tmp2.x = tmp2.x + self.acceleration.x;
  local tmp3 = self.delta_v;
  tmp3.y = tmp3.y + self.acceleration.y;
end
Entity.prototype.update = function(self) 
  _G.error("Not Implemented",0);
end
Entity.prototype.draw = function(self) 
  _G.error("Not Implemented",0);
end

Main.new = {}
Main.main = function() 
  Main.sceneManager = __managers_SceneManager.new();
end
Main.TIC = function() 
  Main.sceneManager:tic();
end
...
WorldMap.new = {}
WorldMap.init_map_entities = function() 
  local _g = 0;
  while (_g < 240) do 
    _g = _g + 1;
    local x = _g - 1;
    ...
    while (_g1 < 136) do 
      _g1 = _g1 + 1;
      local y = _g1 - 1;
      local sprite_num = _G.mget(x, y);
      if (sprite_num == 15) then 
        __entities_Doggy.add_to_map(x, y);
      end;
    end;
  end;
end

__entities_Doggy.new = function(x,y,dx,dy,accx,accy,collider) 
  local self = _hx_new(__entities_Doggy.prototype)
  __entities_Doggy.super(self,x,y,dx,dy,accx,accy,collider)
  return self
end
__entities_Doggy.super = function(self,x,y,dx,dy,accx,accy,collider) 
  Entity.super(self,x,y,dx,dy,accx,accy,collider);
end
__entities_Doggy.add_to_map = function(mapx,mapy) 
  local wx = mapx * 8;
  local wy = mapy * 8;
  _G.mset(mapx, mapy, 0);
  do return __entities_Doggy.new(wx, wy, 0, 0, 0, 0, __physics_BoxCollider.new(0, 0)) end;
end
__entities_Doggy.prototype = _hx_a();
__entities_Doggy.prototype.update = function(self) 
end
__entities_Doggy.prototype.draw = function(self) 
  __utils_Camera.spr(256, self.pos.x, self.pos.y);
end
__entities_Doggy.__super__ = Entity
setmetatable(__entities_Doggy.prototype,{__index=Entity.prototype})
...
__managers_SceneManager.new = function() 
  local self = _hx_new(__managers_SceneManager.prototype)
  __managers_SceneManager.super(self)
  return self
end
__managers_SceneManager.super = function(self) 
  self:init();
  __managers_SceneManager.ME = self;
end
__managers_SceneManager.prototype = _hx_a();
__managers_SceneManager.prototype.switch_scene = function(self,new_scene) 
  self.currentScene:dispose();
  self.currentScene = new_scene;
end
__managers_SceneManager.prototype.init = function(self) 
  self.currentScene = __scenes_IntroScene.new();
end
__managers_SceneManager.prototype.tic = function(self) 
  self.currentScene:update();
  self.currentScene:draw();
end

__physics_BaseCollider.new = function(x,y) 
  local self = _hx_new()
  __physics_BaseCollider.super(self,x,y)
  return self
end
__physics_BaseCollider.super = function(self,x,y) 
  self.x = x;
  self.y = y;
end

__physics_BoxCollider.new = function(x,y,w,h) 
  local self = _hx_new(__physics_BoxCollider.prototype)
  __physics_BoxCollider.super(self,x,y,w,h)
  return self
end
__physics_BoxCollider.super = function(self,x,y,w,h) 
  if (h == nil) then 
    h = 8;
  end;
  if (w == nil) then 
...
__physics_BoxCollider.prototype = _hx_a();
__physics_BoxCollider.__super__ = __physics_BaseCollider
setmetatable(__physics_BoxCollider.prototype,{__index=__physics_BaseCollider.prototype})
...
__scenes_GameScene.new = function() 
  local self = _hx_new(__scenes_GameScene.prototype)
  __scenes_GameScene.super(self)
  return self
end
__scenes_GameScene.super = function(self) 
  WorldMap.init_map_entities();
end
__scenes_GameScene.__interfaces__ = {__scenes_IScene}
__scenes_GameScene.prototype = _hx_a();
__scenes_GameScene.prototype.update = function(self) 
  Entity.update_all_entities();
end
__scenes_GameScene.prototype.draw = function(self) 
  _G.cls(13);
  __utils_Camera.map(0, 0);
  Entity.draw_all_entities();
end
__scenes_GameScene.prototype.dispose = function(self) 
  Entity.reset();
end

__scenes_IntroScene.new = function() 
  local self = _hx_new(__scenes_IntroScene.prototype)
  __scenes_IntroScene.super(self)
  return self
end
__scenes_IntroScene.super = function(self) 
end
__scenes_IntroScene.__interfaces__ = {__scenes_IScene}
__scenes_IntroScene.prototype = _hx_a();
__scenes_IntroScene.prototype.update = function(self) 
  if (_G.btn(4)) then 
    __managers_SceneManager.ME:switch_scene(__scenes_GameScene.new());
  end;
end
__scenes_IntroScene.prototype.draw = function(self) 
  _G.cls(3);
  _G.print("Press A to start", 20, 20);
end
__scenes_IntroScene.prototype.dispose = function(self) 
end

__utils_Camera.new = {}
__utils_Camera.map = function(x,y,w,h,sx,sy,colorkey,scale) 
  if (scale == nil) then 
    scale = 1;
  end;
  ...
  _G.map(x - __utils_Camera.off_x, y - __utils_Camera.off_y, w, h, sx, sy, colorkey, scale);
end
__utils_Camera.spr = function(sprite_num,x,y,colorkey,scale,flip,rotate,w,h) 
  if (h == nil) then 
    h = 1;
  end;
  if (w == nil) then 
  ...
  _G.spr(sprite_num, x - 8, y - __utils_Camera.off_y, colorkey, scale, flip, rotate, w, h);
end
...
local _hx_static_init = function()
  ...
  __utils_Camera.off_x = 0;
  
  __utils_Camera.off_y = 0;
