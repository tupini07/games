...
return {
    ...
    draw = function()
        ...
        -- TODO make this into a circle and adjust it
        rect(BULLSEYE.hitbox_x, BULLSEYE.hitbox_y,
             BULLSEYE.hitbox_x + BULLSEYE.hitbox_w,
             BULLSEYE.hitbox_y + BULLSEYE.hitbox_h, 11)
    end
}
end
